...
move format
0-5    6 bit - to square;
6-11   6 bit - from square;
12-13  2 bit - promote_type (00 - knight, 01 - bishop, 10 - rook, 11 - qeeen)
14-15  2 bit - move type    (00 - normal, 01 - castle, 10 - promote, 11 enpassant)
*/
...
extern bool move_to_string        (board_t * board, int move, char string[], int size);
